...
probOp = {
    ...
    1: {1: 'pseudopolynomial',
        ...
        7: 'to minimize total cost',
        8: 'none',
        9: 'its numeric value',
        10: 'it is not an optimization problem',
        11: 'to minimize total capacity',
        12: 'to separate the source from the target, respecting the capacities',          
        13: 'to maximize total flow',
        14: 'that both divisions be exact',
        15: 'to maximize the coverage',
        16: 'not to repeat vertices',
        17: 'to choose which edges to include',
        18: 'to expand without introducing cycles',
        19: 'NP-complete',
        20: 'to determine in which order to make the visits',
        21: 'to visit each vertex exactly once',
        22: 'to choose which vertices to include',
        23: 'to maximize cardinality',
        24: 'that all included vertices be neighbors',
        25: 'that none of the included vertices be neighbors',
        26: 'to minimize the cardinality', 
        27: 'that each edge be covered at least once',
        28: 'to identify the largest possible divisor',
